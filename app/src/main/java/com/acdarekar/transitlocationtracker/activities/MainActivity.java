...
import com.acdarekar.transitlocationtracker.TrackingService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setTitle("Register Route");
                dialog.setView(LayoutInflater.from(MainActivity.this).inflate( R.layout.register_route, null));
